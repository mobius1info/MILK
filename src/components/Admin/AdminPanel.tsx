...
import { Package, TrendingUp, TrendingDown, Lock, CreditCard, DollarSign, ShoppingBag, Image, Crown, Settings, Menu, X } from 'lucide-react';
...
type TabType = 'products' | 'deposits' | 'withdrawals' | 'access' | 'category-requests' | 'payment-methods' | 'manual-credit' | 'banners' | 'vip-purchases' | 'vip-levels';
...
const navItems: NavItem[] = [
  ...
  { id: 'access', label: 'Category Access', icon: Lock, group: 'Access Control' },
  { id: 'category-requests', label: 'Category Requests', icon: ShoppingBag, group: 'Access Control' },
...
export default function AdminPanel() {
  ...
  useEffect(() => {
    const titles: Record<TabType, string> = {
      ...
      'access': 'ML MALL - Admin - Access Control',
      'category-requests': 'ML MALL - Admin - Category Requests',
