...
import { Package, TrendingUp, TrendingDown, Lock, CreditCard, DollarSign, ShoppingBag, Image, Crown, Settings } from 'lucide-react';
...
export default function AdminPanel() {
  const [activeTab, setActiveTab] = useState<'products' | 'deposits' | 'withdrawals' | 'access' | 'category-requests' | 'payment-methods' | 'manual-credit' | 'banners' | 'vip-purchases' | 'vip-levels'>('products');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 mb-6">
          ...
          >
            ...
            <span className="font-medium">VIP Purchases</span>
          </button>
          <button
            onClick={() => setActiveTab('vip-levels')}
            className={`flex items-center justify-center sm:justify-start space-x-2 px-4 sm:px-6 py-3 rounded-lg transition-all ${
          ...
          >
            ...
            <span className="font-medium">VIP Settings</span>
          </button>
        </div>
