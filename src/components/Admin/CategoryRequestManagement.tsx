...
export default function CategoryRequestManagement() {
  ...
  const loadRequests = async () => {
    try {
      ...
      let query = supabase
        ...
        .select(`
          *,
          profiles!category_access_requests_user_id_fkey (
            email,
            telegram_username
          )
        `)
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Category Access Requests</h2>
        <p className="text-gray-600">Review and approve user requests for category access</p>
      </div>
