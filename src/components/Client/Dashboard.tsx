...
import { Wallet, TrendingUp, TrendingDown, Clock, Check, X, Users, Copy, Package } from 'lucide-react';
...
export default function Dashboard({ profile, onBalanceUpdate }: DashboardProps) {
  const [activeTab, setActiveTab] = useState<'overview' | 'orders' | 'referrals'>('overview');
