/*
  # Fix product purchase - remove balance deduction
  
  1. Changes
    - Remove balance deduction when purchasing products within VIP batch
    - Remove balance check before product purchase
    - Remove purchase transaction creation
    - Users already paid when buying the VIP level, products should not deduct balance again
  
  2. Notes
    - Balance should only be deducted when buying VIP level (vip_purchases)
    - Individual product purchases within a VIP batch should NOT deduct balance
    - Commission is still credited after completing each product
*/
