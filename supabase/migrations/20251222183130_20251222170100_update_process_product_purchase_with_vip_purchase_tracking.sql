/*
  # Update process_product_purchase with VIP Purchase Tracking

  1. Changes
    - Link product_progress to specific vip_purchase_id
    - Create new progress record for each VIP purchase
    - Allow users to repeat same VIP level with fresh 25 products
  
  2. Logic
    - Progress is now tied to specific VIP purchase, not just category
    - When user completes VIP and purchases again, they get new set of 25 products
    - Each VIP purchase is independent with its own progress
*/
