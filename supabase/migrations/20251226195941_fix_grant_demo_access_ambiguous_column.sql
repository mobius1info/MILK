/*
  # Fix Ambiguous Column in grant_demo_access

  1. Changes
    - Fix ambiguous reference to vip_level_id in INSERT INTO statement
    - Explicitly reference function parameter using grant_demo_access.vip_level_id
