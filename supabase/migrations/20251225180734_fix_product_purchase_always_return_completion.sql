/*
  # Fix Product Purchase Response

  The function was returning "Processing..." message instead of "Product completed!"
  for non-final products. This fixes the logic to always return completion information
  since the product is always purchased and commission is always earned.
*/
...
BEGIN
  ...
  -- Always return product completion info
  RETURN jsonb_build_object(
    'success', true,
