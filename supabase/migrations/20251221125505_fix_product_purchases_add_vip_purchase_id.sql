/*
  # Fix Product Purchases - Add vip_purchase_id
  
  1. Problem
    - INSERT INTO product_purchases is missing vip_purchase_id field
    - vip_purchase_id has NOT NULL constraint
    - Causes error when trying to purchase products
    
  2. Solution
    - Update process_product_purchase function to include vip_purchase_id in INSERT
    - Use v_vip_purchase.id from the VIP purchase record
*/
...
BEGIN
  ...
  -- Insert product purchase record with vip_purchase_id
