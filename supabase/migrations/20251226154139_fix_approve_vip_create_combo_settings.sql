/*
  # Fix approve_vip_purchase to create vip_combo_settings records

  Updates the approve_vip_purchase function to create a record in vip_combo_settings
  when combo is enabled. This is what the client UI reads to show combo products.
*/
...
BEGIN
  ...
  -- STEP 5: Create vip_combo_settings record if combo is enabled
