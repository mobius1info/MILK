/*
  # Auto-mark VIP as completed when all products done
  
  1. Changes
    - Add automatic is_completed = true when completed_products_count reaches products_count
    - This moves VIP from Active to Completed section in UI
  
  2. Logic
    - When user completes all products, is_completed flag is set to true
    - VIP disappears from Active Tasks and appears in Completed
*/
...
BEGIN
  ...
  -- Update completed_products_count and auto-mark as completed when all done
