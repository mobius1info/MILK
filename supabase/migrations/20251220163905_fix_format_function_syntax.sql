/*
  # Fix format() Function Syntax in process_product_purchase

  1. Changes
    - Replace %.2f format specifier with proper PostgreSQL formatting
    - Use round() and CAST to format decimal numbers as strings
    - Fix error messages to work with PostgreSQL format() function

  2. Technical Details
    - PostgreSQL format() doesn't support %.2f syntax
    - Use %s with round()::text for number formatting
