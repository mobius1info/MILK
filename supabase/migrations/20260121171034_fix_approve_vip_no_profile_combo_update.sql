/*
  # Fix approve_vip_purchase Function
  
  Recreate the function to ensure it does NOT update profiles table
  with combo settings - only stores them in vip_purchases and vip_combo_settings.
  
  Changes:
  - Removed any profile updates
  - Only saves combo settings to vip_purchases and vip_combo_settings tables
*/
