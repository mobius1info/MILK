/*
  # Fix grant_demo_access - Remove Invalid ON CONFLICT

  1. Changes
    - Remove ON CONFLICT clause from product_progress INSERT
    - Since we create a new vip_purchase each time, there should be no conflict
    - If there is a conflict, it's a real error that should be reported
