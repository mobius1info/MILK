/*
  # Create VIP Combo Settings Table

  1. New Tables
    - `vip_combo_settings`
      - `id` (uuid, primary key)
      - `vip_purchase_id` (uuid, references vip_purchases)
      - `combo_position` (integer) - which product number is a combo
      - `combo_multiplier` (integer) - commission multiplier
      - `combo_deposit_percent` (integer) - deposit requirement %
