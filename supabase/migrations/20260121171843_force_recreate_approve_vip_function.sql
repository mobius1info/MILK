/*
  # Force recreate approve_vip_purchase function
  
  Recreating to clear any potential cache issues.
  This function does NOT update profiles table at all.
*/

DROP FUNCTION IF EXISTS approve_vip_purchase(uuid, uuid, boolean, integer, integer, integer);
DROP FUNCTION IF EXISTS approve_vip_purchase(uuid, uuid, boolean, integer, numeric, integer);
