/*
  # Fix commission - use VIP level settings for fixed amount
  
  1. Changes
    - Commission = (VIP price × VIP commission%) / products count
    - All products in same VIP level get same commission
    - Example: VIP 1 = ($100 × 15%) / 25 = $0.60 per product
  
  2. Formula
    - Commission = vip_purchase.amount_paid × (vip_level.commission_percentage / 100) / vip_level.products_count
    - This ensures consistent commission regardless of product price
*/
