/*
  # Fix Progress Tracking - Update on Each Purchase

  Update `completed_products_count` in vip_purchases after each product purchase,
  not just when all products are completed.
*/
...
BEGIN
  ...
  -- Update completed products count after EACH purchase
