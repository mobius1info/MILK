/*
  # Fix grant_demo_access - Use Correct product_progress Column Names

  1. Changes
    - Update grant_demo_access to use correct column names from product_progress table
    - Replace completed_count with products_purchased and current_product_index
    - Replace last_purchase_at with last_product_at
