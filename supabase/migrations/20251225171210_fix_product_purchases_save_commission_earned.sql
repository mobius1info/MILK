/*
  # Fix product_purchases to save commission_earned
  
  1. Changes
    - Update process_product_purchase to save commission_earned in product_purchases
    - This allows client to calculate total_commission_earned correctly
    - Commission is saved only when product is completed
  
  2. Notes
    - Client reads commission_earned from product_purchases to show total earned
    - Without this field, total shows $0.00
*/
...
BEGIN
  ...
  -- Calculate commission before insert
  ...
  -- Insert product purchase record with commission (no balance deduction)
