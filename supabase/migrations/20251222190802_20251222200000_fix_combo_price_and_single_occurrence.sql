/*
  # Fix COMBO Product Logic

  1. Changes
    - COMBO price = VIP price * (Deposit % / 100), not random
    - COMBO occurs only ONCE at specific position (e.g., 9th product), not every N products

  2. Examples
    - If VIP price = $100, Deposit % = 50, Combo position = 9
    - Then: Only 9th product is COMBO, price = $50
    - Not: 9th, 18th, 27th... products are COMBO
*/
...
BEGIN
  ...
  -- FIXED: COMBO occurs only ONCE at specific position (not every N products)
