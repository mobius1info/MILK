/*
  # Fix Product Purchases - Add price_paid field
  
  1. Problem
    - INSERT INTO product_purchases is missing price_paid field
    - price_paid has NOT NULL constraint
    - Causes error when trying to purchase products
    
  2. Solution
    - Update process_product_purchase function to include price_paid in INSERT
    - price_paid = product_price (the actual price paid by user)
*/
