/*
  # Fix grant_demo_access - Allow Demo Access for Completed Purchases

  1. Problem
    - Function was blocking demo access if user had ANY demo purchase (amount_paid = 0)
    - Should only block if user has ACTIVE (not completed) demo purchase
    - Users should be able to receive demo access multiple times

  2. Solution
    - Check for existing demo purchase with is_completed = false
    - Allow granting demo access if previous demos are completed
