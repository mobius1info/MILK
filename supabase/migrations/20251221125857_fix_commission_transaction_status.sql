/*
  # Fix Commission Transaction Status
  
  1. Problem
    - process_product_purchase function inserts transactions with status 'approved'
    - transactions table check constraint only allows: 'pending', 'completed', 'failed'
    - Causes constraint violation error
    
  2. Solution
    - Update function to use 'completed' status instead of 'approved'
*/
