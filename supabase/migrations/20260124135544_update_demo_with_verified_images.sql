/*
  # Update Demo Products with Verified Name-Image Pairs (same as Accessories)
*/
...
DECLARE
  demo_cat_id UUID;
BEGIN
  SELECT id INTO demo_cat_id FROM categories WHERE name = 'Demo';
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 0);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 1);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 2);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 3);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 4);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 5);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 6);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 7);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 8);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 9);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 10);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 11);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 12);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 13);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 14);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 15);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 16);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 17);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 18);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 19);

  UPDATE products SET 
    name = 'Aviator Sunglasses',
    description = 'Classic aviator sunglasses',
    image_url = 'https://images.pexels.com/photos/701877/pexels-photo-701877.jpeg?auto=compress&cs=tinysrgb&w=800'
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 20);

  UPDATE products SET 
    name = 'Gold Tie Clip',
    description = 'Elegant gold tie clip',
    image_url = 'https://images.pexels.com/photos/45055/pexels-photo-45055.jpeg?auto=compress&cs=tinysrgb&w=800'
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 21);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 22);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 23);
  ...
  WHERE id = (SELECT id FROM products WHERE category_id = demo_cat_id ORDER BY name LIMIT 1 OFFSET 24);
END $$;
