/*
  # Fix combo mode - check balance before purchase

  1. Changes
    - If combo is enabled, check if user has enough balance
    - If balance insufficient, return error "Please top up your account"
    - If combo is disabled, purchase is free
    - Commission is always credited regardless

  2. Logic
    - Combo enabled + insufficient balance = error
    - Combo enabled + sufficient balance = purchase without deduction + commission
    - Combo disabled = purchase without deduction + commission
*/
